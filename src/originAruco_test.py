...
def main():
    ...
    # pc.set_pose(0.577, 0.1, 0.434, 90, 0, 90)
    original_pose = np.array([0.577, 0.1, 0.434])
    T_new = np.array([[1, 0, 0, 0.627],
                      [0, 1, 0, 0.0],
                      [0, 0, 1, 0.434],
                      [0, 0, 0, 1]])
    while True:
    # for _ in range(50):
        # original_pose += 0.05
        # pc.set_pose(original_pose[0], original_pose[1], original_pose[2], 90, 0, 90)
