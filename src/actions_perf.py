...
class ActionsPerf(object):
    def __init__(self, device='cpu', camid=0):
        ...
        self.model = VideoMAEForVideoClassification.from_pretrained("/home/userlab/iri_lab/iri_ws/src/dressing_kinova/src/checkpoint-120", attn_implementation="sdpa").to(self.device)
