...
class TrajectoryControl:
    ...
    def new_how_way_point_action(self):
    ...
    def example_cartesian_waypoint_action(self, traj):
        self.last_action_notif_type = None
        ...
        if config.output.model == ModelId.MODEL_ID_L31:
            ...
            goal.trajectory.append(self.FillCartesianWaypoint(self.home[0],  self.home[1],   self.home[2],  math.radians(0), math.radians(180), math.radians(0), 0))
            ...
            for i in range(traj.shape[0]):
                point = traj[i]
                print(point)
                goal.trajectory.append(self.FillCartesianWaypoint(point[0],  point[1],   point[2],  math.radians(0), math.radians(180), math.radians(0), 0))
            # goal.trajectory.append(self.FillCartesianWaypoint(0.3,  -0.30,   0.405,  math.radians(0), math.radians(180), math.radians(0), 0))
